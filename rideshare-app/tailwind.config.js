  ...
  theme: {
    extend: {
      ...
      boxShadow: {
        ...
        float: "0 20px 40px -12px rgb(99 102 241 / 0.25)",
        'glow-sm': "0 0 20px -5px rgb(99 102 241 / 0.2)",
        'glow-md': "0 0 40px -10px rgb(99 102 241 / 0.3)",
        inner: "inset 0 2px 4px 0 rgb(0 0 0 / 0.04)",
        'bottom-nav': "0 -4px 20px -6px rgb(0 0 0 / 0.08)",
      },
      keyframes: {
        "accordion-down": {
          from: { height: "0" },
